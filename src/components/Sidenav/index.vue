<template>
  ...
  <div
    ...
    :class="`${darkMode ? 'bg-trasnparent' : 'bg-smartlegis'}`"
  />
    ...
    <div class="sidenav-header">
      ...
      <router-link class="m-0 navbar-brand" to="/">
        <img
          ...
          alt="main_logo"
        />
        <span class="ms-2 font-weight-bold">SmartLegis</span>
      </router-link>
    </div>
...
import logo from "@/assets/img/SmartLogo.png";
import logoWhite from "@/assets/img/SmartLogo.png";
